...
const AppBadge: React.FC<AppBadgeProps> = ({ 
  ...
  return (
    <span 
      className={`inline-flex items-center justify-center whitespace-nowrap leading-tight px-2.5 py-1 text-xs font-medium rounded-full border ${colorClass} ${className}`}
      {...rest}
    >
      {children}
    </span>
